...
baltic <- read_parquet(
  paste0(inputpath,
         "gfdl-mom6-cobalt2_obsclim_thetao_15arcmin_baltic-sea-mizer_mthly_clim_mean_1981_2010.parquet"))
baltic_woa <- read_parquet(
  paste0(inputpath,
         "regridded_woa_baltic-sea-mizer_month_clim_mean_temp_1981-2010.parquet"))
baltic_areacello <- read_parquet(
  paste0(inputpath,
         "gfdl-mom6-cobalt2_areacello_15arcmin_baltic-sea-mizer_fixed.parquet"))
baltic_depth <- read_parquet(
  paste0(inputpath,
